...
//@interface Mackay_Daniel_UtilityAppObject : NSObject
//@end

@interface Mackay_Daniel_UtilityAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Mackay_Daniel_UtilityAppObject class]])
		{
			for (NSString *key in [[(Mackay_Daniel_UtilityAppObject*)o modules] allKeys])
			{
