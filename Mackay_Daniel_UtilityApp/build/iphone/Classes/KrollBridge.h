...
@interface Mackay_Daniel_UtilityAppObject : KrollCoverageObject {
#else
@interface Mackay_Daniel_UtilityAppObject : KrollObject {
#endif
@private
...
extern NSString * Mackay_Daniel_UtilityApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Mackay_Daniel_UtilityAppObject *_mackay_daniel_utilityapp;
    KrollObject* console;
	BOOL shutdown;
