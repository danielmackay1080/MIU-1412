 ...
 * to send analytic data that can be viewed on the Mackay_Daniel_UtilityApp Dashboard.
 *
 * For information on getting started with Mackay_Daniel_UtilityApp Platform Services,
