...
/**
 The base class for all Mackay_Daniel_UtilityApp modules
 */
...
/**
 Mackay_Daniel_UtilityApp Platform calls this method on startup.
 */
-(void)startup;

/**
 Mackay_Daniel_UtilityApp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Mackay_Daniel_UtilityApp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Mackay_Daniel_UtilityApp Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Mackay_Daniel_UtilityApp Platform calls this method on resume.
 @param sender The sender of the event.
 */
