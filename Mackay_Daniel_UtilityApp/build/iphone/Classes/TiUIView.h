...
/**
 Base class for all Mackay_Daniel_UtilityApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Mackay_Daniel_UtilityApp view hierarchy (such as wrapped iOS UIViews) was touched.
