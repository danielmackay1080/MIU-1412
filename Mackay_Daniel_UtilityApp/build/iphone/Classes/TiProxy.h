...
//Rare exceptions to indicate a bug in the _mackay_daniel_utilityapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Mackay_Daniel_UtilityApp proxies.
 */
