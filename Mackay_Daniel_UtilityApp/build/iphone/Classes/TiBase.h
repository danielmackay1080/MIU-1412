...
// in simulator we redefine to format for Mackay_Daniel_UtilityApp Developer console
...
{\
	NSString * exceptionName = [@"org.mackay_daniel_utilityapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mackay_daniel_utilityapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMackay_Daniel_UtilityAppNativeItemNone = -1, 
	UIMackay_Daniel_UtilityAppNativeItemSpinner = -2,
	UIMackay_Daniel_UtilityAppNativeItemProgressBar = -3,
	
	UIMackay_Daniel_UtilityAppNativeItemSlider = -4,
	UIMackay_Daniel_UtilityAppNativeItemSwitch = -5,
	UIMackay_Daniel_UtilityAppNativeItemMultiButton = -6,
	UIMackay_Daniel_UtilityAppNativeItemSegmented = -7,
	
	UIMackay_Daniel_UtilityAppNativeItemTextView = -8,
	UIMackay_Daniel_UtilityAppNativeItemTextField = -9,
	UIMackay_Daniel_UtilityAppNativeItemSearchBar = -10,
	
	UIMackay_Daniel_UtilityAppNativeItemPicker = -11,
	UIMackay_Daniel_UtilityAppNativeItemDatePicker = -12,
	
	UIMackay_Daniel_UtilityAppNativeItemInfoLight = -13,
	UIMackay_Daniel_UtilityAppNativeItemInfoDark = -14,
	
	UIMackay_Daniel_UtilityAppNativeItemDisclosure = -15,
	
	UIMackay_Daniel_UtilityAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Mackay_Daniel_UtilityApp instances of
