...
@interface Mackay_Daniel_InfoAppObject : KrollCoverageObject {
#else
@interface Mackay_Daniel_InfoAppObject : KrollObject {
#endif
@private
...
extern NSString * Mackay_Daniel_InfoApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Mackay_Daniel_InfoAppObject *_mackay_daniel_infoapp;
    KrollObject* console;
	BOOL shutdown;
