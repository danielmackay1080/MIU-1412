...
// in simulator we redefine to format for Mackay_Daniel_InfoApp Developer console
...
{\
	NSString * exceptionName = [@"org.mackay_daniel_infoapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mackay_daniel_infoapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMackay_Daniel_InfoAppNativeItemNone = -1, 
	UIMackay_Daniel_InfoAppNativeItemSpinner = -2,
	UIMackay_Daniel_InfoAppNativeItemProgressBar = -3,
	
	UIMackay_Daniel_InfoAppNativeItemSlider = -4,
	UIMackay_Daniel_InfoAppNativeItemSwitch = -5,
	UIMackay_Daniel_InfoAppNativeItemMultiButton = -6,
	UIMackay_Daniel_InfoAppNativeItemSegmented = -7,
	
	UIMackay_Daniel_InfoAppNativeItemTextView = -8,
	UIMackay_Daniel_InfoAppNativeItemTextField = -9,
	UIMackay_Daniel_InfoAppNativeItemSearchBar = -10,
	
	UIMackay_Daniel_InfoAppNativeItemPicker = -11,
	UIMackay_Daniel_InfoAppNativeItemDatePicker = -12,
	
	UIMackay_Daniel_InfoAppNativeItemInfoLight = -13,
	UIMackay_Daniel_InfoAppNativeItemInfoDark = -14,
	
	UIMackay_Daniel_InfoAppNativeItemDisclosure = -15,
	
	UIMackay_Daniel_InfoAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Mackay_Daniel_InfoApp instances of
