 ...
 * to send analytic data that can be viewed on the Mackay_Daniel_InfoApp Dashboard.
 *
 * For information on getting started with Mackay_Daniel_InfoApp Platform Services,
