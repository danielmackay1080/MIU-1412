...
//@interface Mackay_Daniel_InfoAppObject : NSObject
//@end

@interface Mackay_Daniel_InfoAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Mackay_Daniel_InfoAppObject class]])
		{
			for (NSString *key in [[(Mackay_Daniel_InfoAppObject*)o modules] allKeys])
			{
