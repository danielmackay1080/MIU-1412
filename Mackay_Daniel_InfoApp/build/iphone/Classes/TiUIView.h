...
/**
 Base class for all Mackay_Daniel_InfoApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Mackay_Daniel_InfoApp view hierarchy (such as wrapped iOS UIViews) was touched.
