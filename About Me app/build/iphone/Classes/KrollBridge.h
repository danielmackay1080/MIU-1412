...
@interface AboutMeappObject : KrollCoverageObject {
#else
@interface AboutMeappObject : KrollObject {
#endif
@private
...
extern NSString * AboutMeapp$ModuleRequireFormat;
