...
/**
 Base class for all AboutMeapp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AboutMeapp view hierarchy (such as wrapped iOS UIViews) was touched.
