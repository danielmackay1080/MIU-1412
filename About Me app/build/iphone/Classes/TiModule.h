...
/**
 The base class for all AboutMeapp modules
 */
...
/**
 AboutMeapp Platform calls this method on startup.
 */
-(void)startup;

/**
 AboutMeapp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 AboutMeapp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 AboutMeapp Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 AboutMeapp Platform calls this method on resume.
 @param sender The sender of the event.
 */
