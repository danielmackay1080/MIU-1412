...
//@interface AboutMeappObject : NSObject
//@end

@interface AboutMeappObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AboutMeappObject class]])
		{
			for (NSString *key in [[(AboutMeappObject*)o modules] allKeys])
			{
