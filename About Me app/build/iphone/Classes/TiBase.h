...
// in simulator we redefine to format for AboutMeapp Developer console
...
{\
	NSString * exceptionName = [@"org.aboutmeapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.aboutmeapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAboutMeappNativeItemNone = -1, 
	UIAboutMeappNativeItemSpinner = -2,
	UIAboutMeappNativeItemProgressBar = -3,
	
	UIAboutMeappNativeItemSlider = -4,
	UIAboutMeappNativeItemSwitch = -5,
	UIAboutMeappNativeItemMultiButton = -6,
	UIAboutMeappNativeItemSegmented = -7,
	
	UIAboutMeappNativeItemTextView = -8,
	UIAboutMeappNativeItemTextField = -9,
	UIAboutMeappNativeItemSearchBar = -10,
	
	UIAboutMeappNativeItemPicker = -11,
	UIAboutMeappNativeItemDatePicker = -12,
	
	UIAboutMeappNativeItemInfoLight = -13,
	UIAboutMeappNativeItemInfoDark = -14,
	
	UIAboutMeappNativeItemDisclosure = -15,
	
	UIAboutMeappNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AboutMeapp instances of
